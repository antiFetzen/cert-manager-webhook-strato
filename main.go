...
import (
	python_strato_certbot "cert-manager-webhook-strato/internal/python-strato-certbot"
...
// (!) Moved from stratoDNSProviderConfig to internal.types.StratoDNSProviderConfig
...
func (c *stratoDNSProviderSolver) Present(ch *v1alpha1.ChallengeRequest) error {
	...
	python_strato_certbot.Present(cfg, ch)
...
func (c *stratoDNSProviderSolver) CleanUp(ch *v1alpha1.ChallengeRequest) error {
	...
	python_strato_certbot.CleanUp(cfg, ch)
...
func loadConfig(cfgJSON *extapi.JSON) (types.StratoDNSProviderConfig, error) {
	cfg := types.StratoDNSProviderConfig{}
